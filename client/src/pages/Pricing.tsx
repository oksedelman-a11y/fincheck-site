...
export default function Pricing() {
  ...
  return (
    <div className="flex flex-col gap-12 max-w-5xl pb-16">
      <div className="max-w-3xl">
        <h1 className="text-3xl md:text-5xl font-bold tracking-tight mb-6 text-balance">Экспресс-диагностика 1 блока</h1>
